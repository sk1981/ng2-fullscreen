...
/***/ function(module, exports, __webpack_require__) {
	...
	var FullScreenIfDemoComponent_1 = __webpack_require__(58);
	var BasicComponent_1 = __webpack_require__(59);
	var DemoOverviewComponent_1 = __webpack_require__(60);
	var DemoMainComponent_1 = __webpack_require__(61);
	var FullScreenTargetDemoComponent_1 = __webpack_require__(62);
	var DemoAppRoutes = [
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FullScreen_1 = __webpack_require__(54);
	var FullScreenIf_1 = __webpack_require__(57);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(3);
	var FullScreenDOMService_1 = __webpack_require__(55);
	var FullScreenEventService_1 = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FullScreenDOMService = (function () {
	    ...
	    FullScreenDOMService.prototype.requestForElement = function (elRef) {
	        this.request(elRef.nativeElement);
	    };
	    FullScreenDOMService.prototype.requestForSelector = function (selector) {
	        var fullScreenTargetArr = document.querySelectorAll(selector);
	        var targetNativeElement = fullScreenTargetArr[0];
	        this.request(targetNativeElement);
	    };
	    FullScreenDOMService.prototype.cancel = function () {
	        // this.renderer.setElementClass(nativeElement, 'fullscreen', false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FullScreenIf = (function () {
	    function FullScreenIf(elRef, fullScreenService, fullScreenEventService) {
	        ...
	        this.screenChangeListener = fullScreenEventService.addListener(function (event) {
	            if (event.target === _this.elRef.nativeElement) {
	                _this.isFullScreen = !_this.isFullScreen;
	                console.log("new status ---", _this.isFullScreen);
	                _this.fullscreenIfChange.emit(_this.fullscreenIf);
	            }
	        });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FullScreenIfDemoComponent = (function () {
	    ...
	    FullScreenIfDemoComponent.prototype.myChange = function (event) {
	        console.log("change event", event);
	        this.isFull = !this.isFull;
	        this.isFullChange.emit(this.isFull);
	    };
	    FullScreenIfDemoComponent.prototype.ngOnChanges = function (changes) {
	        console.log("triggered", changes);
	    };
	    __decorate([
	        core_1.Input(), 
	        __metadata('design:type', Object)
	    ], FullScreenIfDemoComponent.prototype, "isFull", void 0);
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', (typeof (_a = typeof core_1.EventEmitter !== 'undefined' && core_1.EventEmitter) === 'function' && _a) || Object)
	    ], FullScreenIfDemoComponent.prototype, "isFullChange", void 0);
